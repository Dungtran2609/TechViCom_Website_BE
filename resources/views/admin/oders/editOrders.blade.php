                            ...
                            <form action="{{ route('admin.order.updateOrders', $orderData['id']) }}" method="POST">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="payment_method" class="form-control" {{ $orderData['status'] !== 'pending' ? 'disabled' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="shipping_method_id" class="form-control" {{ $orderData['status'] !== 'pending' ? 'disabled' : '' }}>
