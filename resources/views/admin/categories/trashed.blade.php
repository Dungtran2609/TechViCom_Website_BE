                        ...
                        <tbody>
                            @foreach($categories as $category)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('admin.categories.restore', $category->category_id) }}" method="POST" class="d-inline">
                                            @csrf
                                            <button type="submit" class="btn btn-sm btn-success">
                                                <i class="fas fa-undo"></i> Khôi phục
                                            </button>
                                        </form>
                                        <form action="{{ route('admin.categories.force-delete', $category->category_id) }}" method="POST" class="d-inline" onsubmit="return confirm('Xoá vĩnh viễn?')">
                                            @csrf
                                            @method('DELETE')
