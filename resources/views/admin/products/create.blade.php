                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('type') is-invalid @enderror" name="type"
                                    id="type">
                                    <option value="simple" @if (old('type', 'simple') == 'simple') selected @endif>Sản phẩm đơn
                                    </option>
                                    <option value="variable" @if (old('type') == 'variable') selected @endif>Sản phẩm biến
                                        thể</option>
                                </select>
                                @error('type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror" name="status"
                                    ...
                                    <option value="active" {{ old('status', 'active') == 'active' ? 'selected' : '' }}>
                                        Hiển thị</option>
                                    <option value="inactive" {{ old('status') == 'inactive' ? 'selected' : '' }}>Ẩn
                                    </option>
                                </select>
                                @error('status')
                                    <div class="invalid-feedback">{{ $message }}</div>
